...
Tenho experiência com SQL, análise de dados e investigação de erros, além de participação ativa na identificação e solução de problemas junto ao time de desenvolvimento. Também desenvolvo projetos próprios, incluindo um sistema ERP em C# com arquitetura em camadas, focado em gestão de estoque.
...
Análise e correção de problemas em sistemas ERP
